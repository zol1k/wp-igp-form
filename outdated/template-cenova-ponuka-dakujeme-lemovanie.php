<?php
/**
 * Template Name: Cenová ponuka - Ďakujeme - Lemovanie
 *
 */
?>
<?php get_header() ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const keysToClear = [
            ...
            'massgefertigteType', 'massgefertigteTitle',
            'massgefertigteSubtype', 'massgefertigteSubtypeTitle',
            
            // Úprava a farba
            'massgefertigteColor',
            'massgefertigteInfo',
            'massgefertigteFileName'
        ];
