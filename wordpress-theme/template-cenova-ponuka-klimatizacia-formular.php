 ...
 *
 * One-page formular — výber parametrov klimatizácie.
 * Po vyplnení všetkých polí a kliknutí na "Pokračovať" uloží
 * hodnoty do sessionStorage a presmeruje na vyhodnotenie.
 *
 * Session keys:
 *   formular_rozmer
 *   formular_priprava
...
$vyhodnotenie_url = home_url( '/cenova-ponuka-rozcestnik/cenova-ponuka-vyhodnotenie/' );
$back_url         = home_url( '/cenova-ponuka-rozcestnik/cenova-ponuka-klimatizacie/' );
?>
...
<div class="igp-page-container">
    ...
    <a href="<?php echo esc_url( $back_url ); ?>"
       class="igp-btn-outline mb-4 d-inline-block">
        <i class="bi bi-arrow-left me-1"></i> Späť na výber produktu
    </a>

    <h1 class="igp-step-heading mb-1">Parametre klimatizácie</h1>
    <p class="igp-step-subheading mb-4">
        Vyberte možnosti, ktoré najlepšie vystihujú vaše potreby.
        Pomôžu nám pripraviť presnú cenovú ponuku.
    </p>

    <form id="igp-formular" novalidate>

        <!-- ── Rozmer miestnosti ──────────────────────────────────────────── -->
        <p class="igp-question-label">Rozmer miestnosti</p>
        <div id="f-rozmer" class="igp-option-group row g-3 mb-2">
        ...
        <div id="f-priprava" class="igp-option-group row g-3 mb-2">
        ...
        <div id="f-filtracia" class="igp-option-group row g-3 mb-2">
            <div class="col-12 col-md-6">
        ...
        <div id="f-farba" class="igp-option-group row g-3 mb-2">
            <div class="col-12 col-md-6">
        ...
        <div id="f-vyuzitie" class="igp-option-group row g-3 mb-2">
            <div class="col-12 col-md-6">
        ...
        <div id="f-prevedenie" class="igp-option-group row g-3 mb-2">
            <div class="col-12 col-md-4">
...
document.addEventListener('DOMContentLoaded', function() {
    IGPForm.initCards('#f-rozmer',    'formular_rozmer',    { gaEvent: 'formular_rozmer_click'    });
    IGPForm.initCards('#f-priprava',  'formular_priprava',  { gaEvent: 'formular_priprava_click'  });
    IGPForm.initCards('#f-filtracia', 'formular_filtracia', { gaEvent: 'formular_filtracia_click' });
    IGPForm.initCards('#f-farba',     'formular_farba',     { gaEvent: 'formular_farba_click'     });
    IGPForm.initCards('#f-vyuzitie',  'formular_vyuzitie',  { gaEvent: 'formular_vyuzitie_click'  });
    IGPForm.initCards('#f-prevedenie','formular_prevedenie',{ gaEvent: 'formular_prevedenie_click'});

    // Clear validation highlight when a card is selected inside a group
    document.getElementById('igp-formular').addEventListener('click', function(e) {
...
/**
 * Validates all groups are selected, then navigates to vyhodnotenie.
 * Invalid groups get a red outline; clears on next card selection via delegation.
 */
function igpFormularPokracovat() {
    var groups = [
        { id: 'f-rozmer',    key: 'formular_rozmer',    },
        { id: 'f-priprava',  key: 'formular_priprava',  },
        { id: 'f-filtracia', key: 'formular_filtracia', },
        { id: 'f-farba',     key: 'formular_farba',     },
        { id: 'f-vyuzitie',  key: 'formular_vyuzitie',  },
        { id: 'f-prevedenie',key: 'formular_prevedenie',},
    ];
    ...
    if (firstError) {
        ...
        console.warn('[IGP] Formulár — chýba výber v skupine:', firstError.id);
        return;
    }

    IGPForm.sendGA('formular_continue', {});
    window.location.href = '<?php echo esc_js( $vyhodnotenie_url ); ?>';
}
</script>
